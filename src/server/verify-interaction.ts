 ...
 */
export function valueToUint8Array(value: BufferStringLike, format = 'hex'): Uint8Array {
...
export function verifyKey({body, signature, timestamp, clientPublicKey}: Options) {
	try {
