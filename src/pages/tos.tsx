		...
		<div className="py-24 mx-auto max-w-4xl px-5 relative z-10">
			<main className="py-16 space-y-6">
				...
				<ul>
					<li>
						<p>
							<strong>Application</strong> means the software program provided by the Company used
							by you through the Discord platform, named StreamTicker
						</p>
					</li>
					...
					<li>
						<p>
							<strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean t ese
				...
				<p>
					...
					that operates between You and the Company. These Terms and Conditions set out he rights
